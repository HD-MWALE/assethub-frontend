...
export default function RegisterV2() {
  return (
    <>
      <div className="mx-auto flex w-full flex-col justify-center space-y-8 sm:w-[380px] max-h-[90vh] overflow-y-auto">
        <div className="space-y-6 text-center">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-sm">Create your account to start managing assets</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-border after:border-t">
            <span className="relative z-10 bg-background px-2 text-muted-foreground">Or create with email</span>
          </div>
          <RegisterForm />
        </div>
        ...
        <div className="rounded-lg border border-border bg-muted/30 p-4 text-center text-sm text-muted-foreground">
          ...
          <Link prefetch={false} className="text-primary font-medium hover:underline" href="login">
            Sign in here
          </Link>
        </div>
      </div>
